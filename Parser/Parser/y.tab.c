...
static const yytype_uint16 yyrline[] =
{
     ...
     591,   596,   601,   606,   623,   641,   656,   671,   689,   751,
     762,   775,   801,   823,   828,   912,   921,   931,   937,   947,
     953,  1013,  1018,  1066,  1076,  1086,  1092,  1097,  1143,  1155,
    1170,  1190,  1200,  1211,  1221,  1225,  1244
};
#endif
...
#line 214 "parser.y" /* yacc.c:1646  */
    {
             ...
             if(symboltable->Lookup((yyvsp[-4].args).mystr)!= NULL){
               ...
               cout<<"\n\nHERE-"<<return_Type<<"--FUNC-RET--"<<symboltable->Lookup((yyvsp[-4].args).mystr)->getDataType()<<"--\n\n";
               if(symboltable->Lookup((yyvsp[-4].args).mystr)->getDataType() != return_Type&& return_Type != "" && returnFlag){
                 error_count++;
                 fprintf(error,"Error %d at line %d: Return Type does not match\n\n",error_count,line_count,(yyvsp[-4].args).mystr);
               }
...
#line 775 "parser.y" /* yacc.c:1646  */
    {
              ...
              if(symboltable->Lookup((yyvsp[0].args).mystr) == NULL){
                ...
                fprintf(error, "Error %d at Line %d: Expected [ after Array type\n\n",error_count , line_count);
                  ...
                  cout<<"\n-->"<<symboltable->Lookup((yyvsp[0].args).mystr)->getName()<<" Data types  "<<symboltable->Lookup((yyvsp[0].args).mystr)->getDataType()<<endl;
...
#line 1271 "parser.y" /* yacc.c:1906  */
