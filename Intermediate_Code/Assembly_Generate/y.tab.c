...
{
       0,   133,   133,   169,   189,   196,   201,   206,   213,   256,
     283,   283,   413,   412,   600,   636,   656,   688,   702,   702,
     775,   775,   795,   816,   827,   837,   848,   868,   897,   919,
     945,   951,   968,   973,   979,   984,  1067,  1148,  1205,  1281,
    1312,  1400,  1413,  1435,  1469,  1612,  1617,  1756,  1761,  1838,
    1843,  1957,  1963,  2081,  2086,  2263,  2321,  2370,  2376,  2381,
    2462,  2478,  2491,  2511,  2566,  2617,  2623,  2629,  2655
};
#endif
...
{
      27,   -69,   -69,   -69,     9,    27,   -69,   -69,   -69,   -69,
      13,   -69,   -69,   -15,   -11,    17,    20,    45,   -69,    10,
     -13,    53,    28,    32,   -69,    41,    36,    27,   -69,   -69,
      70,    46,   -69,   -69,    41,    79,    54,    78,    52,   -69,
     -69,   -69,   -69,    99,    -6,   -69,    99,    82,    92,    94,
      99,    99,    96,   -69,   -69,   -69,    89,    50,   -69,   -69,
     -18,    71,   -69,   110,    25,   111,   -69,   -69,   -69,    40,
     -69,    99,    99,   105,    99,     5,    99,    81,   -69,   118,
      87,   -69,   -69,    99,   -69,   -69,   -69,    99,    99,    99,
      99,   -69,   112,    93,    88,   -69,   113,     5,   114,   -69,
     115,   -69,   -69,   111,   124,   -69,   -69,    99,   -69,    78,
      99,    78,    95,   -69,   133,   119,   -69,   -69,    78,    78,
     -69,   -69
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,    17,     0,    26,     9,     0,    12,     0,    16,    29,
       0,    18,    11,     8,     0,    15,     0,     0,     0,    13,
      14,    27,    62,     0,    43,    61,     0,     0,     0,     0,
       0,     0,     0,    41,    34,    32,     0,     0,    30,    33,
      58,     0,    45,    47,    49,    51,    53,    57,    21,    58,
      55,    66,     0,     0,     0,     0,     0,     0,    56,     0,
      28,    19,    31,     0,    63,    64,    42,     0,     0,     0,
       0,    68,     0,    65,     0,    60,     0,     0,     0,    40,
       0,    46,    48,    52,    50,    54,    59,     0,    44,     0,
       0,     0,     0,    67,    37,     0,    38,    39,     0,     0,
      36,    35
};
...
{
     -69,   -69,   -69,   136,   -69,   -69,   -69,   -69,   -69,    -4,
     -69,   -69,    61,   109,   -69,   -69,   -51,   -59,   -43,   -45,
     -68,    51,    55,    57,   -41,   -69,   -69,   -69
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     4,     5,     6,     7,     8,    25,    34,    20,    54,
...
{
      69,    73,    70,    91,    15,    77,    82,    26,    69,    11,
      78,    42,    43,    71,    44,   101,    97,    83,    45,    84,
      85,    32,    13,    27,    46,    17,    16,    94,    69,    96,
      39,    98,    88,    22,    18,    72,    89,    19,   110,   113,
      69,     1,     2,     3,    69,    69,    69,    69,    51,   105,
      53,     1,     2,     3,    23,    24,    42,    43,   114,    44,
     116,     9,    28,    45,    69,   115,     9,   120,   121,    46,
      29,    47,    48,    30,     1,     2,     3,    84,    85,    49,
      31,    33,    50,    36,    42,    43,   -20,    44,    40,    31,
      81,    45,    68,    51,    52,    53,    41,    46,    80,    47,
      48,    74,     1,     2,     3,    42,    43,    49,    44,    10,
      50,    75,    45,    76,    10,    79,    86,    31,    46,    90,
      87,    51,    52,    53,    21,    95,    99,   100,    16,   107,
     108,    88,   106,   109,   111,   112,    35,   118,   102,   119,
     117,    12,    51,     0,   104,   103
};

static const yytype_int8 yycheck[] =
{
      43,    46,    43,    71,    19,    50,    57,    20,    51,     0,
      51,     6,     7,    19,     9,    83,    75,    35,    13,    37,
      38,    25,     9,    36,    19,    36,    41,    72,    71,    74,
      34,    76,     7,    13,    45,    41,    11,    20,    97,   107,
      83,    24,    25,    26,    87,    88,    89,    90,    43,    90,
      45,    24,    25,    26,     9,    45,     6,     7,   109,     9,
     111,     0,     9,    13,   107,   110,     5,   118,   119,    19,
      42,    21,    22,    41,    24,    25,    26,    37,    38,    29,
      39,    45,    32,    13,     6,     7,    40,     9,     9,    39,
      40,    13,    40,    43,    44,    45,    42,    19,     9,    21,
      22,    19,    24,    25,    26,     6,     7,    29,     9,     0,
      32,    19,    13,    19,     5,    19,    45,    39,    19,     8,
      10,    43,    44,    45,    15,    20,    45,     9,    41,    36,
      42,     7,    20,    20,    20,    20,    27,     4,    87,    20,
      45,     5,    43,    -1,    89,    88
};
...
{
       0,    24,    25,    26,    47,    48,    49,    50,    51,    58,
      59,     0,    49,     9,    60,    19,    41,    36,    45,    20,
      54,    59,    13,     9,    45,    52,    20,    36,     9,    42,
      41,    39,    55,    45,    53,    59,    13,    56,    57,    55,
       9,    42,     6,     7,     9,    13,    19,    21,    22,    29,
      32,    43,    44,    45,    55,    58,    59,    61,    62,    63,
      64,    65,    66,    67,    68,    69,    70,    71,    40,    64,
      70,    19,    41,    65,    19,    19,    19,    65,    70,    19,
       9,    40,    62,    35,    37,    38,    45,    10,     7,    11,
       8,    66,    72,    73,    65,    20,    65,    63,    65,    45,
       9,    66,    67,    69,    68,    70,    20,    36,    42,    20,
      63,    20,    20,    66,    62,    65,    62,    45,     4,    20,
      62,    62
};
...
static const yytype_uint8 yyr1[] =
{
      ...
      52,    51,    53,    51,    54,    54,    54,    54,    56,    55,
      57,    55,    58,    59,    59,    59,    60,    60,    60,    60,
...
#line 169 "parser.y" /* yacc.c:1646  */
    {
					...
					char * tmp = (char *) malloc(20+strlen((yyvsp[-1].args).mystr)+strlen((yyvsp[0].args).mystr)+10);
					char tmp2[2];
					tmp2[0]='\n';tmp2[1]='\0';
          ...
          char * ctmp = (char *) malloc(20+strlen((yyvsp[-1].args).code)+strlen((yyvsp[0].args).code)+10);
          char ctmp2[2];
          ctmp2[0]='\n';ctmp2[1]='\0';
...
#line 213 "parser.y" /* yacc.c:1646  */
    {
               ...
               tmp[0]='(';tmp[1]='\0';
               char * tmp2 = (char *)
               malloc(20+strlen((yyvsp[-5].args).mystr)+strlen((yyvsp[-4].args).mystr)+1+strlen((yyvsp[-2].args).mystr)+22);
...
#line 256 "parser.y" /* yacc.c:1646  */
    {
               ...
               char tmp[2];
               tmp[0]='(';tmp[1]='\0';
               char * tmp2 = (char *) malloc(20+strlen((yyvsp[-4].args).mystr)+strlen((yyvsp[-3].args).mystr)+23);
...
#line 283 "parser.y" /* yacc.c:1646  */
    {
         ...
         if(symboltable->Lookup((yyvsp[-2].args).mystr) != NULL){
           if(symboltable->Lookup((yyvsp[-2].args).mystr)->getDataType() != return_Type && return_Type != "" && returnFlag){
             error_count++;
             fprintf(error,"Error %d at line %d: Return Type does not match\n\n",error_count,line_count,(yyvsp[-2].args).mystr);
           }
           if(symboltable->Lookup((yyvsp[-2].args).mystr)->getDataStructure()=="FUNCTION.DEC"){
             SymbolInfo *s = symboltable->Lookup((yyvsp[-2].args).mystr);
             s->setDataStructure("FUNCTION.DEF");
           }
           else if(symboltable->Lookup((yyvsp[-2].args).mystr)->getDataStructure()=="FUNCTION.DEF"){
             flag = 0;
             error_count++;
             fprintf(error,"Error %d at line %d: Redefinition of  %s\n\n",error_count,line_count,(yyvsp[-2].args).mystr);
           }
           if(symboltable->Lookup((yyvsp[-2].args).mystr)->getDataType() != (yyvsp[-3].args).mystr){
               error_count++;
               fprintf(error,"Error %d at line %d: Conflicting return-type for %s\n\n",error_count,line_count,(yyvsp[-2].args).mystr);
             }
         }
         else{
           symboltable->Insert((yyvsp[-2].args).mystr , "ID","FUNCTION.DEF");
           symboltable->Lookup((yyvsp[-2].args).mystr)->setDataType((yyvsp[-3].args).mystr);
           if(symboltable->Lookup((yyvsp[-2].args).mystr)->getDataType() != return_Type && return_Type != "" && returnFlag){
             error_count++;
             fprintf(error,"Error %d at line %d: Return Type does not match\n\n",error_count,line_count,(yyvsp[-2].args).mystr);
           }
...
#line 317 "parser.y" /* yacc.c:1646  */
    {
      	 		fprintf(logout,"At line no: %d func_definition : type_specifier ID LPAREN  RPAREN compound_statement\n\n",line_count);
						char tmp[2];
 						tmp[0]='(';tmp[1]='\0';
 						char * tmp2 = (char *) malloc(55+strlen((yyvsp[-5].args).mystr)+strlen((yyvsp[-4].args).mystr)+4+strlen((yyvsp[0].args).mystr));
 						strcpy(tmp2 , (yyvsp[-5].args).mystr);
 						strcat(tmp2 , (yyvsp[-4].args).mystr);
 						strcat(tmp2 , tmp);
 						tmp[0] = ')';
            ...
            char * ctmp2 = (char *) malloc(55+strlen((yyvsp[-4].args).mystr)+35+strlen((yyvsp[0].args).code));
            ...
            if(!strcmp((yyvsp[-4].args).mystr , "main")){
...
#line 413 "parser.y" /* yacc.c:1646  */
    {
                ...
                SymbolInfo *s;
                if(symboltable->Lookup((yyvsp[-3].args).mystr)!= NULL){
                  cout<<return_Type<<"- FUNC-RET--"<<symboltable->Lookup((yyvsp[-3].args).mystr)->getDataType()<<"--\n\n";
                  if(symboltable->Lookup((yyvsp[-3].args).mystr)->getDataType() != return_Type && return_Type != "" && returnFlag){
                    error_count++;
                    fprintf(error,"Error %d at line %d: Return Type does not match\n\n",error_count,line_count,(yyvsp[-3].args).mystr);
                  }
                    if(symboltable->Lookup((yyvsp[-3].args).mystr)->getDataStructure()=="FUNCTION.DEC"){
                      flag = 0;
                      s = symboltable->Lookup((yyvsp[-3].args).mystr);
                      s->setDataStructure("FUNCTION.DEF");
                      //checking parameters
                    ...
                    else if(symboltable->Lookup((yyvsp[-3].args).mystr)->getDataStructure()=="FUNCTION.DEF"){
                      flag = 0;
                      error_count++;
                      fprintf(error,"Error %d at line %d: Redefinition of  %s\n\n",error_count,line_count,(yyvsp[-3].args).mystr);
                    }
                    if(symboltable->Lookup((yyvsp[-3].args).mystr)->getDataType() != (yyvsp[-4].args).mystr){
                      error_count++;
                      fprintf(error,"Error %d at line %d: Conflicting return-type for %s\n\n",error_count,line_count,(yyvsp[-3].args).mystr);
                    }
                }
                else{
                  symboltable->Insert((yyvsp[-3].args).mystr , "ID","FUNCTION.DEF");
                  s = symboltable->Lookup((yyvsp[-3].args).mystr);
                  s->setDataType((yyvsp[-4].args).mystr);
...
#line 484 "parser.y" /* yacc.c:1646  */
    {
             ...
             (yyval.args).code = (yyvsp[0].args).code;
             char tmp[2];
						 tmp[0]='(';tmp[1]='\0';
						 char * tmp2 = (char *) malloc(55+strlen((yyvsp[-6].args).mystr)+strlen((yyvsp[-5].args).mystr)+1+strlen((yyvsp[-3].args).mystr)+1+strlen((yyvsp[0].args).mystr));
						 strcpy(tmp2 , (yyvsp[-6].args).mystr);
						 strcat(tmp2 , (yyvsp[-5].args).mystr);
						 strcat(tmp2 , tmp);
						 strcat(tmp2 , (yyvsp[-3].args).mystr);
						 tmp[0] = ')';
						 strcat(tmp2 , tmp);
             ...
             char * ctmp2 = (char *) malloc(25+strlen((yyvsp[-5].args).mystr)+35+strlen((yyvsp[0].args).code));
             strcat(ctmp2 , (yyvsp[-5].args).mystr);
             ctmp[0]=' ';ctmp[1]='\0';
             strcat(ctmp2 , ctmp);
             ctmp[0]='P';ctmp[1]='R';ctmp[2]='O';ctmp[3]='C';ctmp[4]='\n';ctmp[5]='\0';
             strcat(ctmp2 , ctmp);

             if(!strcmp((yyvsp[-5].args).mystr , "main")){
                ctmp[0]='M';ctmp[1]='O';ctmp[2]='V';ctmp[3]=' ';ctmp[4]='A';ctmp[5]='X';ctmp[6]='\0';
               strcat(ctmp2 , ctmp);
               ctmp[0]=',';ctmp[1]='@';ctmp[2]='D';ctmp[3]='A';ctmp[4]='T';ctmp[5]='A';ctmp[6]='\n';ctmp[7]='\0';
               strcat(ctmp2 , ctmp);
...
#line 600 "parser.y" /* yacc.c:1646  */
    {
              ...
              (yyval.args).code = (yyvsp[-3].args).code;

              char tmp[2];
              tmp[0]=',';tmp[1]='\0';
              char * tmp2 = (char *) malloc(15+strlen((yyvsp[-3].args).mystr)+1+strlen((yyvsp[-1].args).mystr)+strlen((yyvsp[0].args).mystr));
...
#line 636 "parser.y" /* yacc.c:1646  */
    {
              ...
              char tmp[2];
              tmp[0]=',';tmp[1]='\0';
              char * tmp2 = (char *) malloc(15+strlen((yyvsp[-2].args).mystr)+1+strlen((yyvsp[0].args).mystr));
...
#line 656 "parser.y" /* yacc.c:1646  */
    {
              ...
              char * tmp2 = (char *) malloc(15+strlen((yyvsp[-1].args).mystr)+strlen((yyvsp[0].args).mystr));
...
#line 713 "parser.y" /* yacc.c:1646  */
    {
							...
							char tmp[2];
							tmp[0]='{';tmp[1]='\0';
							char * tmp2 = (char *) malloc(15+strlen((yyvsp[-1].args).mystr)+5);
							strcpy(tmp2 , tmp);
							tmp[0] = '\n';
							strcat(tmp2 , tmp);
							strcat(tmp2 , (yyvsp[-1].args).mystr);
              ...
              char * ctmp2 = (char *) malloc(20+strlen(ctmp)*4+30+strlen((yyvsp[-1].args).code)+strlen((yyvsp[-1].args).mystr)+20);
              ...
              param_list.clear();
              strcat(ctmp2 , (yyvsp[-1].args).code);
...
#line 795 "parser.y" /* yacc.c:1646  */
    {
				...
				char * tmp = (char *) malloc(1 + strlen((yyvsp[-2].args).mystr) + 15 + strlen((yyvsp[-1].args).mystr));
...
#line 848 "parser.y" /* yacc.c:1646  */
    {
						...
						char * tmp = (char *) malloc(11 + strlen((yyvsp[-2].args).mystr)+ 1+strlen((yyvsp[0].args).mystr) );
			      strcpy(tmp, (yyvsp[-2].args).mystr);
						char tmp2[2];
						tmp2[1] = '\0';
						tmp2[0] = ',';
            ...
            char integer[2];
            sprintf(integer, "%d", symboltable->getCurrentScope()->getScopeNumber());
            char * var = (char *) malloc(15+strlen((yyvsp[0].args).mystr));
            strcpy(var , (yyvsp[0].args).mystr);
            strcat(var , integer);
            DATA_SEGMENT.push_back(var);
...
#line 868 "parser.y" /* yacc.c:1646  */
    {
            ...
            char inte[2];
            sprintf(inte, "%d", symboltable->getCurrentScope()->getScopeNumber());
            char * var = (char *) malloc(15+strlen((yyvsp[-3].args).mystr));
            strcpy(var , (yyvsp[-3].args).mystr);
            strcat(var , inte);
            DATA_SEGMENT_ARR.push_back(var);
            DATA_SEGMENT_ARR_SIZE.push_back((yyvsp[-1].args).intvalue);

						char integer[2];
						sprintf(integer, "%d", (yyvsp[-1].args).intvalue);
						char * tmp = (char *) malloc(12 + strlen((yyvsp[-5].args).mystr)+ 1+strlen((yyvsp[-3].args).mystr)+3 );
...
#line 919 "parser.y" /* yacc.c:1646  */
    {
            ...
            DATA_SEGMENT_ARR_SIZE.push_back((yyvsp[-1].args).intvalue);
						...
						char integer[2];
						sprintf(integer, "%d", (yyvsp[-1].args).intvalue);
 						char * tmp2 = (char *) malloc(15+strlen((yyvsp[-3].args).mystr)+1+strlen(integer)+1);
 						strcpy(tmp2 , (yyvsp[-3].args).mystr);
 						strcat(tmp2 , tmp);
						strcat(tmp2 , integer);
						tmp[0]=']';
...
#line 951 "parser.y" /* yacc.c:1646  */
    {
            ...
            char * ctmp2 = (char *) malloc(15+strlen((yyvsp[-1].args).code)+strlen((yyvsp[0].args).code));
...
#line 984 "parser.y" /* yacc.c:1646  */
    {
						...
						char tmp[4];
 						...
 						char * tmp2 = (char *) malloc(19+strlen(tmp)+1+strlen((yyvsp[-4].args).mystr)+strlen((yyvsp[-4].args).mystr)+strlen((yyvsp[-4].args).mystr)+1+strlen((yyvsp[0].args).mystr));
 						strcpy(tmp2 , tmp);
						tmp[0]='(';tmp[1]='\0';
 						strcat(tmp2 , tmp);
 						strcat(tmp2 , (yyvsp[-4].args).mystr);
            ...
            char ctmp[10];
            ctmp[9] = '\0';
            char * ctmp2 = (char *) malloc(20+strlen(ctmp)*16+30+strlen((yyvsp[-2].args).code)+strlen((yyvsp[-4].args).code)+strlen((yyvsp[-3].args).code)+1+strlen((yyvsp[0].args).code)+20);

            strcpy(ctmp2 , (yyvsp[-4].args).code);
            ...
            strcat(ctmp2 , (yyvsp[-3].args).code);
            ctmp[0]='M';ctmp[1]='O';ctmp[2]='V';ctmp[3]=' ';ctmp[4]='A';ctmp[5]='X';ctmp[6]=',';ctmp[7]='\0';
            strcat(ctmp2 , ctmp);

            if((yyvsp[-3].args).VAR_NAME != NULL){
              strcat(ctmp2 , (yyvsp[-3].args).VAR_NAME);
            }
            else{
              strcat(ctmp2 , (yyvsp[-3].args).mystr);
            }
            ...
            (yyval.args).LABEL  = exitloop;
             ...
             strcat(ctmp2 , exitloop);
              ...
              strcat(ctmp2 , (yyvsp[-2].args).code); //Increment Iterator
              ctmp[0]='\n';ctmp[1]='\0';
              strcat(ctmp2 , ctmp);
...
#line 1067 "parser.y" /* yacc.c:1646  */
    {
						...
						char tmp[5];
 						...
 						char * tmp2 = (char *) malloc(20+strlen(tmp)+strlen(tmp)+strlen((yyvsp[-4].args).mystr)+90+strlen((yyvsp[-2].args).mystr)+strlen(tmp)+strlen((yyvsp[0].args).mystr));
 						strcpy(tmp2 , tmp);
						tmp[0]='(';tmp[1]='\0';
 						strcat(tmp2 , tmp);
 						strcat(tmp2 , (yyvsp[-4].args).mystr);
            ...
            char * ctmp2 = (char *) malloc(30+strlen(ctmp)*4+strlen((yyvsp[-2].args).code)+strlen((yyvsp[0].args).code)+strlen((yyvsp[-4].args).code)+strlen((yyvsp[-4].args).mystr)+1);

            strcpy(ctmp2 , (yyvsp[-4].args).code);

            strcat(ctmp2 , ctmp);
            if((yyvsp[-4].args).VAR_NAME != NULL){
              strcat(ctmp2 , (yyvsp[-4].args).VAR_NAME);
            }
            else{
              strcat(ctmp2 , (yyvsp[-4].args).mystr);
            }
...
#line 1148 "parser.y" /* yacc.c:1646  */
    {
							...
							char tmp[5];
							tmp[0]='i';tmp[1]='f';tmp[2]='\0';
							char * tmp2 = (char *) malloc(30+strlen(tmp)+2+strlen((yyvsp[-2].args).mystr)+1+strlen((yyvsp[0].args).mystr));
							strcpy(tmp2 , tmp);
							tmp[0]='(';tmp[1]='\0';
							strcat(tmp2 , tmp);
							strcat(tmp2 , (yyvsp[-2].args).mystr);
            ...
            char * ctmp2 = (char *) malloc(30+strlen(ctmp)*4+strlen((yyvsp[0].args).code)+strlen((yyvsp[-2].args).code)+strlen((yyvsp[-2].args).mystr)+1);
            strcat(ctmp2 , (yyvsp[-2].args).code);

            strcat(ctmp2 , ctmp);
            if((yyvsp[-2].args).VAR_NAME != NULL){
              strcat(ctmp2 , (yyvsp[-2].args).VAR_NAME);
            }
            else{
...
#line 1205 "parser.y" /* yacc.c:1646  */
    {
						...
						tmp[0]='w';tmp[1]='h';tmp[2]='i';tmp[3]='l';tmp[4]='e';tmp[5]='\0';
 						char * tmp2 = (char *) malloc(30+strlen(tmp)+1+strlen((yyvsp[-2].args).mystr)+1+strlen((yyvsp[0].args).mystr));
 						strcpy(tmp2 , tmp);
						tmp[0]='(';tmp[1]='\0';
 						strcat(tmp2 , tmp);
 						strcat(tmp2 , (yyvsp[-2].args).mystr);
            ...
            char ctmp[10];
            ctmp[9] = '\0';
            char * ctmp2 = (char *) malloc(30+strlen(ctmp)*16+strlen((yyvsp[0].args).code)+strlen((yyvsp[-2].args).code)+20);
...
#line 1281 "parser.y" /* yacc.c:1646  */
    {
            ...
            if(symboltable->Lookup((yyvsp[-2].args).mystr) == NULL){
              ...
              char integer[2];
              sprintf(integer, "%d", symboltable->Lookup((yyvsp[-2].args).mystr)->getCurrentScope());
              strcat((yyvsp[-2].args).mystr, integer);
              (yyval.args).code = printID((yyvsp[-2].args).mystr);

            }

						char tmp[8];
						tmp[0]='p';tmp[1]='r';tmp[2]='i';tmp[3]='n';tmp[4]='t';tmp[5]='l';tmp[6]='n';tmp[7]='\0';
 						char * tmp2 = (char *) malloc(30+strlen(tmp)+1+strlen((yyvsp[-2].args).mystr)+2);
 						strcpy(tmp2 , tmp);
						tmp[0]='(';tmp[1]='\0';
 						strcat(tmp2 , tmp);
 						strcat(tmp2 , (yyvsp[-2].args).mystr);
...
#line 1312 "parser.y" /* yacc.c:1646  */
    {
						...
						char * tmp2 = (char *) malloc(30+strlen((yyvsp[-1].args).mystr)+9);
						strcpy(tmp2 , tmp);
						strcat(tmp2 , (yyvsp[-1].args).mystr);
						tmp[0]=';';tmp[1]='\0';
						strcat(tmp2 , tmp);
            ...
            char * ctmp2 = (char *) malloc(30+strlen(ctmp)*6+strlen((yyvsp[-1].args).code)+strlen((yyvsp[-1].args).mystr)+20);
            strcat(ctmp2 , (yyvsp[-1].args).code);
            strcat(ctmp2 , ctmp);
            if((yyvsp[-1].args).VAR_NAME != NULL){
              strcat(ctmp2 , (yyvsp[-1].args).VAR_NAME);
            }
            else{
              strcat(ctmp2 , (yyvsp[-1].args).mystr);
            }
...
#line 1413 "parser.y" /* yacc.c:1646  */
    {
              ...
              char tmp[2];
              tmp[0]=';';tmp[1]='\0';
              char * tmp2 = (char *) malloc(12+strlen((yyvsp[-1].args).mystr)+5);
              strcpy(tmp2 , (yyvsp[-1].args).mystr);
              strcat(tmp2 , tmp);
              tmp[0]='\n';tmp[1]='\0';
              strcat(tmp2 , tmp);
              ...
              char * ctmp2 = (char *) malloc(20+strlen((yyvsp[-1].args).code)+15);

              strcpy(ctmp2 , (yyvsp[-1].args).code);
              tmp[0]='\n';tmp[1]='\0';
              strcat(ctmp2 , tmp);
              (yyval.args).code = ctmp2;
              (yyval.args).VAR_NAME = (yyvsp[-1].args).VAR_NAME;
              fprintf(logout,"%s \n\n",(yyval.args).mystr);
...
#line 1435 "parser.y" /* yacc.c:1646  */
    {
              ...
              if(symboltable->Lookup((yyvsp[0].args).mystr) == NULL){
                ...
                fprintf(error, "Error %d at Line %d: Expected [ after Array type\n\n",error_count , line_count);
                  ...
                  char integer[2];
                  sprintf(integer, "%d", symboltable->Lookup((yyvsp[0].args).mystr)->getCurrentScope());
                  char * var = (char *) malloc(15+strlen((yyvsp[0].args).mystr));
                  strcat(var, (yyvsp[0].args).mystr);
                  strcat(var, integer);
                  //strcat($1.mystr , integer);
                  (yyval.args).VAR_NAME = var;
...
#line 1469 "parser.y" /* yacc.c:1646  */
    {
             ...
             char * ctmp2 = (char *) malloc(19+strlen((yyvsp[-1].args).code)+strlen((yyvsp[-3].args).mystr)+strlen((yyvsp[-1].args).mystr)+50);
             strcpy(ctmp2 , (yyvsp[-1].args).code);

             char tmp[2];
             tmp[0]='[';tmp[1]='\0';
             char * tmp2 = (char *) malloc(19+strlen((yyvsp[-3].args).mystr)+1+strlen((yyvsp[-1].args).mystr)+1);
             strcpy(tmp2 , (yyvsp[-3].args).mystr);
             strcat(tmp2 , tmp);
             strcat(tmp2 , (yyvsp[-1].args).mystr);
             tmp[0]=']';
             ...
             if(symboltable->Lookup((yyvsp[-3].args).mystr)->getDataStructure() == ""){
              ...
              if(symboltable->Lookup((yyvsp[-3].args).mystr) != NULL){
                if(symboltable->Lookup((yyvsp[-3].args).mystr)->getDataStructure() == "ARRAY"){

                  char inte[2];
                  sprintf(inte, "%d", symboltable->Lookup((yyvsp[-3].args).mystr)->getCurrentScope());
                  //char * var = (char *) malloc(15+strlen($1.mystr));
                  strcat((yyvsp[-3].args).mystr , inte);
...
#line 1617 "parser.y" /* yacc.c:1646  */
    {
            ...
            char tmp[2];
						tmp[0]='=';tmp[1]='\0';
						char * tmp2 = (char *) malloc(11+strlen((yyvsp[-2].args).mystr)+strlen((yyvsp[0].args).mystr)+1);
						strcpy(tmp2 , (yyvsp[-2].args).mystr);
						strcat(tmp2 , tmp);
						strcat(tmp2 , (yyvsp[0].args).mystr);
            int flag = 1;
            ...
            char * ctmp2 = (char *) malloc(1+46+strlen((yyvsp[-2].args).code)+strlen((yyvsp[0].args).code)+1);
            strcpy(ctmp2 , (yyvsp[0].args).code);
            strcat(ctmp2 , (yyvsp[-2].args).code);

            strcat(ctmp2 , ctmp);

            if((yyvsp[0].args).VAR_NAME == NULL){
              strcat(ctmp2 , (yyvsp[0].args).mystr);
            }
            else{
              strcat(ctmp2 , (yyvsp[0].args).VAR_NAME);
            }
            ...
            strcat(ctmp2 , ctmp);
            if(symboltable->Lookup((yyvsp[-2].args).mystr)!= NULL){
              if(symboltable->Lookup((yyvsp[-2].args).mystr)->getDataStructure() == "ARRAY"){
                char integer[2];
                sprintf(integer, "%d", symboltable->Lookup((yyvsp[-2].args).mystr)->getCurrentScope());
                strcat((yyvsp[-2].args).mystr, integer);
                strcat(ctmp2 , (yyvsp[-2].args).mystr);
...
#line 1761 "parser.y" /* yacc.c:1646  */
    {
 						...
 						char * tmp2 = (char *) malloc(11+strlen((yyvsp[-2].args).mystr)+strlen((yyvsp[-1].args).mystr)+strlen((yyvsp[0].args).mystr));
 						strcpy(tmp2 , (yyvsp[-2].args).mystr);
 						strcat(tmp2 , (yyvsp[-1].args).mystr);
 						strcat(tmp2 , (yyvsp[0].args).mystr);
 						(yyval.args).mystr = tmp2;
            ...
            char * ctmp2 = (char *) malloc(19+strlen(ctmp)*4+strlen((yyvsp[-2].args).mystr)+strlen((yyvsp[0].args).mystr)+strlen((yyvsp[-2].args).code)+strlen((yyvsp[0].args).code)+30);
            strcat(ctmp2 , (yyvsp[0].args).code);
            strcpy(ctmp2 , (yyvsp[-2].args).code);
            ...
            if(!strcmp((yyvsp[-1].args).mystr , "&&")){
              ctmp[0]='A';ctmp[1]='N';ctmp[2]='D';ctmp[3]=' ';ctmp[4]='\0';
              strcat(ctmp2 , ctmp);
            }
            else if(!strcmp((yyvsp[-1].args).mystr , "||")){
...
#line 1843 "parser.y" /* yacc.c:1646  */
    {
						...
						char * tmp2 = (char *) malloc(19+strlen((yyvsp[-2].args).mystr)+strlen((yyvsp[-1].args).mystr)+strlen((yyvsp[0].args).mystr));
						strcpy(tmp2 , (yyvsp[-2].args).mystr);
						strcat(tmp2 , (yyvsp[-1].args).mystr);
						strcat(tmp2 , (yyvsp[0].args).mystr);
						(yyval.args).mystr = tmp2;
              ...
              char * ctmp2 = (char *) malloc(19+strlen(ctmp)*4+strlen((yyvsp[-2].args).code)+strlen((yyvsp[0].args).code)+strlen((yyvsp[-2].args).mystr)+strlen((yyvsp[0].args).mystr)+1);
...
#line 1963 "parser.y" /* yacc.c:1646  */
    {
            ...
            char * ctmp2 = (char *) malloc(29+strlen(ctmp)*4+strlen((yyvsp[-2].args).mystr)+strlen((yyvsp[0].args).mystr)+strlen((yyvsp[-2].args).code)+strlen((yyvsp[0].args).code)+30);
            strcat(ctmp2 , (yyvsp[0].args).code);
            strcpy(ctmp2 , (yyvsp[-2].args).code);
            ...
            char tmp[2];
						...
						char * tmp2 = (char *) malloc(19+strlen((yyvsp[-2].args).mystr)+1+strlen((yyvsp[0].args).mystr));
						strcpy(tmp2 , (yyvsp[-2].args).mystr);
						strcat(tmp2 , tmp);
						strcat(tmp2 , (yyvsp[0].args).mystr);
						(yyval.args).mystr = tmp2;
...
#line 2086 "parser.y" /* yacc.c:1646  */
    {
           ...
           fprintf(logout,"At line no: %d term :	term MULOP unary_expression\n\n",line_count);
					 char tmp[2];
					 tmp[0]=(yyvsp[-1].args).charvalue ;tmp[1]='\0';
					 char * tmp2 = (char *) malloc(11+strlen((yyvsp[-2].args).mystr)+1+strlen((yyvsp[0].args).mystr));
					 strcpy(tmp2 , (yyvsp[-2].args).mystr);
					 strcat(tmp2 , tmp);
					 strcat(tmp2 , (yyvsp[0].args).mystr);
           ...
           if((yyvsp[-1].args).charvalue == '%'){
             ...
             char * ctmp2 = (char *) malloc(30+strlen(ctmp)*4+strlen((yyvsp[-2].args).mystr)+strlen((yyvsp[0].args).mystr)+strlen((yyvsp[-2].args).code)+strlen((yyvsp[0].args).code)+1);
             strcpy(ctmp2 , (yyvsp[-2].args).code);
             strcat(ctmp2 , (yyvsp[0].args).code);
             ...
             if(((yyvsp[-2].args).intvalue != NULL && (yyvsp[0].args).intvalue == NULL) || ((yyvsp[-2].args).intvalue == NULL && (yyvsp[0].args).intvalue != NULL)){
              ...
              char * ctmp2 = (char *) malloc(19+strlen(ctmp)*4+strlen((yyvsp[-2].args).mystr)+strlen((yyvsp[0].args).mystr)+strlen((yyvsp[-2].args).code)+strlen((yyvsp[0].args).code)+1);
              strcpy(ctmp2 , (yyvsp[-2].args).code);
              strcat(ctmp2 , (yyvsp[0].args).code);
...
#line 2263 "parser.y" /* yacc.c:1646  */
    {
							...
							char tmp[2];
							tmp[0]=(yyvsp[-1].args).charvalue;tmp[1]='\0';
							char * tmp2 = (char *) malloc(19+strlen((yyvsp[0].args).mystr));
							strcat(tmp2 , tmp);
							strcat(tmp2 , (yyvsp[0].args).mystr);
							(yyval.args).mystr = tmp2;
							fprintf(logout,"%s \n\n",tmp2);

              if((yyvsp[0].args).charvalue == '-'){
                char ctmp[8];
                ctmp[0]='M';ctmp[1]='O';ctmp[2]='V';ctmp[3]=' ';ctmp[4]='A';ctmp[5]='X';ctmp[6]=',';ctmp[7]='\0';

                char * ctmp2 = (char *) malloc(19+strlen(ctmp)*3+strlen((yyvsp[0].args).mystr)+strlen((yyvsp[0].args).code)+1);
                strcpy(ctmp2 , (yyvsp[0].args).code);
                ...
                char * ctmp2 = (char *) malloc(19+strlen((yyvsp[0].args).mystr)+strlen((yyvsp[0].args).code)+1);
                strcpy(ctmp2 , (yyvsp[0].args).code);
                (yyval.args).code = ctmp2;
...
#line 2321 "parser.y" /* yacc.c:1646  */
    {
						 ...
						 char tmp[2];
 						 tmp[0]='!';tmp[1]='\0';
 						char * tmp2 = (char *) malloc(19+strlen((yyvsp[0].args).mystr)+1);
 						strcat(tmp2 , tmp);
 						strcat(tmp2 , (yyvsp[0].args).mystr);
 						(yyval.args).mystr = tmp2;
 						fprintf(logout,"%s \n\n",tmp2);
            ...
            char * ctmp2 = (char *) malloc(30+strlen(ctmp)*3+strlen((yyvsp[0].args).mystr)+strlen((yyvsp[0].args).code)+1);
            strcpy(ctmp2 , (yyvsp[0].args).code);
...
#line 2381 "parser.y" /* yacc.c:1646  */
    {
          ...
          char * ctmp2 = (char *) malloc(30+strlen(ctmp)*3+strlen((yyvsp[-1].args).mystr)+strlen((yyvsp[-1].args).code)+1);
          strcpy(ctmp2 , (yyvsp[-1].args).code);
...
#line 2462 "parser.y" /* yacc.c:1646  */
    {
          ...
          (yyval.args) = (yyvsp[-1].args);
					...
					char tmp[2];
					tmp[0]='(';tmp[1]='\0';
					char * tmp2 = (char *) malloc(20+strlen((yyvsp[-1].args).mystr)+2);
					strcat(tmp2 , tmp);
					strcat(tmp2 , (yyvsp[-1].args).mystr);
					tmp[0] = ')';
					strcat(tmp2 , tmp);
...
#line 2511 "parser.y" /* yacc.c:1646  */
    {
          ...
          char * ctmp2 = (char *) malloc(40+strlen(ctmp)*4+strlen((yyvsp[-1].args).mystr)+strlen((yyvsp[-1].args).code)+1);
          strcpy(ctmp2 , (yyvsp[-1].args).code);
          ...
          char tmp[3];
          tmp[0] = '+';tmp[1]='+';tmp[2]='\0';
          char * tmp2 = (char *) malloc(20+strlen((yyvsp[-1].args).mystr)+1);
          strcpy(tmp2 , (yyvsp[-1].args).mystr);
          strcat(tmp2 , tmp);
          (yyval.args).mystr = tmp2;
          fprintf(logout,"%s \n\n",tmp2);
...
#line 2629 "parser.y" /* yacc.c:1646  */
    {
            ...
            char * ctmp2 = (char *) malloc(20+strlen((yyvsp[-2].args).code)+2+strlen((yyvsp[0].args).code));
            strcpy(ctmp2 , (yyvsp[-2].args).code);
            strcat(ctmp2 , (yyvsp[0].args).code);
            (yyval.args).code = ctmp2;
						...
						char tmp[2];
						tmp[0] = ',';tmp[1] = '\0';
						char * tmp2 = (char *) malloc(20+strlen((yyvsp[-2].args).mystr)+2+strlen((yyvsp[0].args).mystr));
						strcpy(tmp2 , (yyvsp[-2].args).mystr);
						strcat(tmp2 , tmp);
						strcat(tmp2 , (yyvsp[0].args).mystr);
            (yyval.args).mystr = tmp2;
            ...
            item->name = (yyvsp[0].args).mystr;
            item->VAR_NAME = (yyvsp[0].args).VAR_NAME;
...
#line 2655 "parser.y" /* yacc.c:1646  */
    {
            ...
            (yyval.args).arg_list->VAR_NAME = (yyvsp[0].args).VAR_NAME;
...
#line 2680 "parser.y" /* yacc.c:1906  */
